...
try:
    ...
    logging.warning("Pybit library not available, using manual API implementation")
...
class BybitAPI:
    def __init__(self, api_key: str, api_secret: str, testnet: bool = False):
        ...
        if PYBIT_AVAILABLE:
            ...
            logger.warning("pybit not available, using manual implementation")
    ...
    def get_futures_balance(self) -> Dict:
        """Get futures balance (fallback method)"""
        try:
    ...
    def get_futures_positions(self) -> Dict:
        """Get futures positions (fallback method)"""
        try:
            # Use manual API call as fallback
    ...
    def set_leverage(self, symbol: str, leverage: int) -> Dict:
        ...
        try:
            if PYBIT_AVAILABLE:
                return self._make_request_with_pybit('set_leverage', 
                    category='linear', 
                    symbol=symbol, 
